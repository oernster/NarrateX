...
def connect_signals(controller) -> None:
    ...
    controller.window.shelf_view.order_changed.connect(controller.order_shelf)
    controller.window.shelf_view.layout_clicked.connect(controller.toggle_shelf_layout)
