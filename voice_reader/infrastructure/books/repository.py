...
# Least share of the book that must land inside displayed blocks before the
...
# always has. Half is a deliberately forgiving bar. A well-formed EPUB scores
    ...
    def _build_document(
        *,
        ...
        if drafts:
            ...
            if document.structured_ratio >= _MIN_STRUCTURED_RATIO:
                return document
